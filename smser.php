...
."<tr style=\"font-weight: bold; background-color: #cccccc;\"><td>ID</td><td>$lang[22]</th><td>$lang[23]</td><td>$lang[24]</td><td>$lang[25]</td><td>User form</td><td>$lang[26]</td></tr>";
...
mysql_query("INSERT INTO aa_text (senderid, text, sent_date, receiver, country_from) VALUES (\"$sndrdd\", \"$msge\", \"$created\", \"$foo\", \"$countr_name\")");
...
echo "['$coss', $rowsewd[c]],";
        ...
        ."new google.visualization.PieChart(document.getElementById('visualizationn'))."
            ."draw(data, {title:\"Messages sent form\"});"
      ."}"
...
if ($row[bul_sets] == "sing") {
				...
				mysql_query("INSERT INTO $txt_table (senderid, text, sent_date, receiver, country_from) VALUES (\"$senderid\", \"$newtext\", \"$created\", \"$newto\", \"$countr_name\")");
